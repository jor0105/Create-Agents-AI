...
class TestChatWithAgentUseCase:
    ...
    def test_execute_with_empty_message_raises_error(
        self, mock_chat_repository
    ):
        use_case = ChatWithAgentUseCase(chat_repository=mock_chat_repository)
        agent = Agent(
    ...
    def test_execute_wraps_generic_exception(self, mock_chat_repository):
        mock_chat_repository.chat.side_effect = RuntimeError(
            'Unexpected error'
        )
        use_case = ChatWithAgentUseCase(chat_repository=mock_chat_repository)
        agent = Agent(
    ...
    def test_execute_does_not_add_to_history_on_error(
        self, mock_chat_repository
    ):
    ...
    def test_execute_with_empty_response_raises_error(
        self, mock_chat_repository
    ):
    ...
    def test_execute_with_none_response_raises_error(
        self, mock_chat_repository
    ):
    ...
    def test_execute_with_special_characters_in_message(
        self, mock_chat_repository
    ):
        mock_chat_repository.chat.return_value = 'Response'
        use_case = ChatWithAgentUseCase(chat_repository=mock_chat_repository)
