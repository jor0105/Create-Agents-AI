...
class TestAvailableTools:
    ...
    def test_readlocalfile_excluded_when_dependencies_missing(self):
        ...
        AvailableTools._AvailableTools__LAZY_SYSTEM_TOOLS['readlocalfile'] = (
            None
        )
    ...
    def test_try_load_read_local_file_tool_logs_warning_on_failure(self):
        ...
        assert (
            'readlocalfile'
            in AvailableTools._AvailableTools__LAZY_SYSTEM_TOOLS
        )
    ...
    def test_lazy_tools_dict_is_class_attribute(self):
        ...
        assert isinstance(
            AvailableTools._AvailableTools__LAZY_SYSTEM_TOOLS, dict
        )
    ...
    def test_docstring_exists(self):
        ...
        assert (
            'Registry' in AvailableTools.__doc__
            or 'registry' in AvailableTools.__doc__
        )
    ...
    def test_get_all_tool_instances_returns_basetool_instances(self):
        ...
        for tool_name, tool in tool_instances.items():
            assert isinstance(tool, BaseTool), (
                f'{tool_name} is not a BaseTool instance'
            )
