...
class TestOllamaChatAdapter:
    ...
    @patch("arcadiumai.infra.adapters.Ollama.ollama_chat_adapter.subprocess.run")
    @patch("arcadiumai.infra.adapters.Ollama.ollama_chat_adapter.chat")
    ...
    def test_initialization_reads_environment_variables(self):
        with patch(
            "arcadiumai.infra.adapters.Ollama.ollama_chat_adapter.EnvironmentConfig.get_env"
        ) as mock_get_env:
