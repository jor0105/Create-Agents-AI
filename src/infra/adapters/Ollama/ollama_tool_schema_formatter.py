"""Tool schema formatter for Ollama native tool calling.

Converts BaseTool instances to Ollama's native function calling format.
Ollama now supports native tool calling similar to OpenAI.
"""
