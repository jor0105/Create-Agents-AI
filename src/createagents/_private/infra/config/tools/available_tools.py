...
class AvailableTools:
    ...
    def _ensure_system_tools_loaded(cls):
        ...
        if not cls.__SYSTEM_TOOLS:
            from ...adapters.Tools import CurrentDateTool  # pylint: disable=import-outside-toplevel
    ...
    def __try_load_read_local_file_tool(cls) -> None:
        ...
        try:
            from ...adapters.Tools import ReadLocalFileTool  # pylint: disable=import-outside-toplevel
